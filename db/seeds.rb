...
50.times do 
    Comment.create(body: Faker::Lorem.paragraph, author_id: rand(1...10), journal_id: rand(1...30), parent_comment_id: nil)
end 

100.times do 
     Comment.create(body: Faker::Lorem.paragraph, author_id: rand(1...10), journal_id: rand(1...30), parent_comment_id: rand(1...50))
end
