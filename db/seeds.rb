...
# 15.times do 
#     c1 = Comment.create(body: Faker::Books::Dune.saying, author_id: rand(1...10), journal_id: rand(1...Journal.all.length), parent_comment_id: nil)
#     Comment.create(body: Faker::Books::Dune.saying, author_id: rand(1...10), journal_id: rand(1...Journal.all.length), parent_comment_id: nil)
#     c3 =Comment.create(body: Faker::Books::Dune.saying, author_id: rand(1...10), journal_id: rand(1...Journal.all.length), parent_comment_id: c1.id)
#     c4 = Comment.create(body: Faker::Books::Dune.saying, author_id: rand(1...10), journal_id: rand(1...Journal.all.length), parent_comment_id: c3.id)
#     Comment.create(body: Faker::Books::Dune.saying, author_id: rand(1...10), journal_id: rand(1...Journal.all.length), parent_comment_id: c4.id)
# end