...
j = Journal.new(title: "Apple the largest US user of solar power, ahead of Amazon", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 1)
file= open("https://midgreen-dev.s3.amazonaws.com/solar/solar-3.jpg")
j.photo.attach(io: file, filename: 'solar-3.jpg')
j.save!

j = Journal.new(title: "Solar power in Maine - Wikipedia", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 1)
file= open("https://midgreen-dev.s3.amazonaws.com/solar/solar-4.jpeg")
j.photo.attach(io: file, filename: 'solar-4.jpeg')
j.save!

j = Journal.new(title: "Study: Even short-lived solar panels can be economically viable", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 1)
file= open("https://midgreen-dev.s3.amazonaws.com/solar/solar-5.jpg")
j.photo.attach(io: file, filename: 'solar-5.jpg')
j.save!

j = Journal.new(title: "8 Solar Energy Facts That May Surprise You | EnergySage", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 1)
file= open("https://midgreen-dev.s3.amazonaws.com/solar/solar-6.jpg")
j.photo.attach(io: file, filename: 'solar-6.jpg')
j.save!

j = Journal.new(title: "2019 Was a Record Year for U.S. Solar Power", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 1)
file= open("https://midgreen-dev.s3.amazonaws.com/solar/solar-7.jpg")
j.photo.attach(io: file, filename: 'solar-7.jpg')
j.save!

j = Journal.new(title: "Wind Tracking and Blade Adjustment", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 2)
file= open("https://midgreen-dev.s3.amazonaws.com/wind/wind-1.jpg")
j.photo.attach(io: file, filename: 'wind-1.jpg')
j.save!

j = Journal.new(title: "Global wind turbine outlook: Asia Pacific leads power generation", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 2)
file= open("https://midgreen-dev.s3.amazonaws.com/wind/wind-2.jpg")
j.photo.attach(io: file, filename: 'wind-2.jpg')
j.save!

j = Journal.new(title: "Denmark eyes 10GW offshore wind 'islands' in $45bn plan", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 2)
file= open("https://midgreen-dev.s3.amazonaws.com/wind/wind-3.jpg")
j.photo.attach(io: file, filename: 'wind-3.jpg')
j.save!

j = Journal.new(title: "Offshore wind still looks to get a foothold", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 2)
file= open("https://midgreen-dev.s3.amazonaws.com/wind/wind-4.jpg")
j.photo.attach(io: file, filename: 'wind-4.jpg')
j.save!

j = Journal.new(title: "5 Wind Power Facts", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 2)
file= open("https://midgreen-dev.s3.amazonaws.com/wind/wind-5.jpg")
j.photo.attach(io: file, filename: 'wind-5.jpg')
j.save!

j = Journal.new(title: "Wind Vision", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 2)
file= open("https://midgreen-dev.s3.amazonaws.com/wind/wind-6.jpg")
j.photo.attach(io: file, filename: 'wind-6.jpg')
j.save!

j = Journal.new(title: "Envision2030: 17 goals to transform the world", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 3)
file= open("https://midgreen-dev.s3.amazonaws.com/SDG/sdg-1.png")
j.photo.attach(io: file, filename: 'sdg-1.png')
j.save!

j = Journal.new(title: "UN SDGs: An Introduction to the UN's 17 Sustainable Development Goals", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 3)
file= open("https://midgreen-dev.s3.amazonaws.com/SDG/sdg-2.png")
j.photo.attach(io: file, filename: 'sdg-2.png')
j.save!

j = Journal.new(title: "Sustainable Development Goals Action Group", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 3)
file= open("https://midgreen-dev.s3.amazonaws.com/SDG/sdg-3.jpg")
j.photo.attach(io: file, filename: 'sdg-3.jpg')
j.save!

j = Journal.new(title: "Sustainable Development Goals adopted", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 3)
file= open("https://midgreen-dev.s3.amazonaws.com/SDG/sdg-4.jpeg")
j.photo.attach(io: file, filename: 'sdg-4.jpeg')
j.save!

j = Journal.new(title: "$500,000 Corporate-led Grants and Mentorship for Young People", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 3)
file= open("https://midgreen-dev.s3.amazonaws.com/SDG/sdg-5.jpg")
j.photo.attach(io: file, filename: 'sdg-5.jpg')
j.save!


j = Journal.new(title: "Mercedes-Benz Concept EQ A", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 4)
file= open("https://midgreen-dev.s3.amazonaws.com/ecar/ec-1.jpeg")
j.photo.attach(io: file, filename: 'ec-1.jpeg')
j.save!

j = Journal.new(title: "BMW Showcases Self-Driving Concept Car", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 4)
file= open("https://midgreen-dev.s3.amazonaws.com/ecar/ec-2.jpg")
j.photo.attach(io: file, filename: 'ec-2.jpg')
j.save!

j = Journal.new(title: "BMW i8 electric car", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 4)
file= open("https://midgreen-dev.s3.amazonaws.com/ecar/ec-3.jpg")
j.photo.attach(io: file, filename: 'ec-3.jpg')
j.save!

j = Journal.new(title: "This is what future BMW electric cars will sound like", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 4)
file= open("https://midgreen-dev.s3.amazonaws.com/ecar/ec-4.jpg")
j.photo.attach(io: file, filename: 'ec-4.jpg')
j.save!

j = Journal.new(title: "Every Tesla car will now include Autopilot", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 4)
file= open("https://midgreen-dev.s3.amazonaws.com/ecar/ec-5.jpg")
j.photo.attach(io: file, filename: 'ec-5.jpg')
j.save!


j = Journal.new(title: "Polar Bear And Global Warming", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 5)
file= open("https://midgreen-dev.s3.amazonaws.com/globalwarming/gw-1.jpg")
j.photo.attach(io: file, filename: 'gw-1.jpg')
j.save!

j = Journal.new(title: "Drought - Global warming", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 5)
file= open("https://midgreen-dev.s3.amazonaws.com/globalwarming/gw-2.jpg")
j.photo.attach(io: file, filename: 'gw-2.jpg')
j.save!

j = Journal.new(title: "Visualizations – Climate Predictiongw-3", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 5)
file= open("https://midgreen-dev.s3.amazonaws.com/globalwarming/gw-3.png")
j.photo.attach(io: file, filename: 'gw-3.png')
j.save!


j = Journal.new(title: "Polar Bear Evolution Tracked Climate Change, New DNA Study ...", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 5)
file= open("https://midgreen-dev.s3.amazonaws.com/globalwarming/gw-4.jpg")
j.photo.attach(io: file, filename: 'gw-4.jpg')
j.save!

j = Journal.new(title: "Exploring Climate Change & Global Warming", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 5)
file= open("https://midgreen-dev.s3.amazonaws.com/globalwarming/gw-5.jpg")
j.photo.attach(io: file, filename: 'gw-5.jpg')
j.save!

j = Journal.new(title: "Global Warming and Violent Behavior", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 5)
file= open("https://midgreen-dev.s3.amazonaws.com/globalwarming/gw-6.jpg")
j.photo.attach(io: file, filename: 'gw-6.jpg')
j.save!


j = Journal.new(title: "How Mexico City plans to fight air pollution", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 6)
file= open("https://midgreen-dev.s3.amazonaws.com/transportation/t-1.jpg")
j.photo.attach(io: file, filename: 't-1.jpg')
j.save!

j = Journal.new(title: "Air Pollution: What India can learn from other countries", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 6)
file= open("https://midgreen-dev.s3.amazonaws.com/transportation/t-2.jpg")
j.photo.attach(io: file, filename: 't-2.jpg')
j.save!

j = Journal.new(title: "Is air quality a social problem?", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 6)
file= open("https://midgreen-dev.s3.amazonaws.com/transportation/t-3.jpg")
j.photo.attach(io: file, filename: 't-3.jpg')
j.save!

j = Journal.new(title: "Who Breathes the Dirtiest Air from Vehicles?", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 6)
file= open("https://midgreen-dev.s3.amazonaws.com/transportation/t-4.jpg")
j.photo.attach(io: file, filename: 't-4.jpg')
j.save!

j = Journal.new(title: "What Causes Air Pollution? | NASA Climate Kids", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 6)
file= open("https://midgreen-dev.s3.amazonaws.com/transportation/t-5.png")
j.photo.attach(io: file, filename: 't-5.png')
j.save!


j = Journal.new(title: "Air Pollution Worsens Bronchiectasis", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 7)
file= open("https://midgreen-dev.s3.amazonaws.com/air/a-1.jpg")
j.photo.attach(io: file, filename: 'a-1.jpg')
j.save!

j = Journal.new(title: "Air pollution's hidden impacts", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 7)
file= open("https://midgreen-dev.s3.amazonaws.com/air/a-2.jpg")
j.photo.attach(io: file, filename: 'a-2.jpg')
j.save!

j = Journal.new(title: "Air Pollution Wallpaper", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 7)
file= open("https://midgreen-dev.s3.amazonaws.com/air/a-3.jpg")
j.photo.attach(io: file, filename: 'a-3.jpg')
j.save!


j = Journal.new(title: "A New View of Wintertime Air Pollution", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 7)
...
j = Journal.new(title: "6 Types of Water Pollution", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 8)
file= open("https://midgreen-dev.s3.amazonaws.com/water/w-1.jpg")
j.photo.attach(io: file, filename: 'w-1.jpg')
j.save!

j = Journal.new(title: "Water and Air Pollution - HISTORY", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 8)
file= open("https://midgreen-dev.s3.amazonaws.com/water/w-2.jpg")
j.photo.attach(io: file, filename: 'w-2.jpg')
j.save!

j = Journal.new(title: "The biggest Water Pollution guide", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 8)
file= open("https://midgreen-dev.s3.amazonaws.com/water/w-3.png")
j.photo.attach(io: file, filename: 'w-3.png')
j.save!

j = Journal.new(title: "Top 4 Consequences of Water Pollution: Can We Eliminate the Causes?", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 8)
file= open("https://midgreen-dev.s3.amazonaws.com/water/w-4.jpg")
j.photo.attach(io: file, filename: 'w-4.jpg')
j.save!


j = Journal.new(title: "How LEED Certified Buildings are Focused on ...", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 9)
file= open("https://midgreen-dev.s3.amazonaws.com/leed/l-1.jpg")
j.photo.attach(io: file, filename: 'l-1.jpg')
j.save!

j = Journal.new(title: "LEED-Certified Buildings Keep Sustainability at Forefront", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 9)
file= open("https://midgreen-dev.s3.amazonaws.com/leed/l-2.jpg")
j.photo.attach(io: file, filename: 'l-2.jpg')
j.save!

j = Journal.new(title: "Leed Certified", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 9)
file= open("https://midgreen-dev.s3.amazonaws.com/leed/l-3.png")
j.photo.attach(io: file, filename: 'l-3.png')
j.save!


j = Journal.new(title: "AASHE", subtitle: Faker::Lorem.paragraph, body: lorem, author_id: rand(1...10), category_id: 10)
file= open("https://midgreen-dev.s3.amazonaws.com/aashe/1.png")
j.photo.attach(io: file, filename: '1.jpg')
j.save!

j = Journal.new(title: "We love the Earth, it is our planet", subtitle: "Lil Dicky's 'Earth' Video Is Band Aid For The Internet", body: lorem, author_id: rand(1...10), category_id: 10)
