...
Comment.create(body: Faker::Lorem.paragraph, author_id: rand(1...10), journal_id: 1, parent_comment_id: nil)
Comment.create(body: Faker::Lorem.paragraph, author_id: rand(1...10), journal_id: 1, parent_comment_id: nil)
Comment.create(body: Faker::Lorem.paragraph, author_id: rand(1...10), journal_id: 1, parent_comment_id: nil)
Comment.create(body: Faker::Lorem.paragraph, author_id: rand(1...10), journal_id: 1, parent_comment_id: 1)
Comment.create(body: Faker::Lorem.paragraph, author_id: rand(1...10), journal_id: 1, parent_comment_id: 1)
Comment.create(body: Faker::Lorem.paragraph, author_id: rand(1...10), journal_id: 1, parent_comment_id: 2)
Comment.create(body: Faker::Lorem.paragraph, author_id: rand(1...10), journal_id: 1, parent_comment_id: 3)
